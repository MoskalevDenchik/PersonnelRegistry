...
INSERT INTO [dbo].[Departments](
            ...
            [Description])
VALUES
(0,'Отдел метала','ул.Еловая, д.10, оф.20','Отдел занимается разработкой костюмов'),
(0,'Отдел галактики','ул.Сосновая, д.23, оф.11','Отдел занимается спасением вселенной'),
(0,'Отдел асгарда','ул.Кедровая, д.13, оф.23','Отдел следит за порядком во всех мирах'),
(0,'Отдел магии','ул.Вафельная, д.40, оф.20','Отдел занимается защитой от других измерений'),
(0,'Отдел стариков','ул.Еловая, д.13, оф.20','Отдел защиты америки'),
(0,'Отдел управления','ул.Кенова, д.10, оф.206','Отдел сбором мстителей');
GO
...
('Прэтт','Крис','Кристофер',2,' Верджиния, Миннесота,США','80298678245','80297894545','80275978245',2,'/Content/Images/Pret.jpg',CAST('2012-01-08 00:00:00.000' as datetime),null,1,0),
('Хемсворт','Крис','Батькович',3,'Мельбурн, Виктория, Австралия','80296578245','80296578245','80296578245',2,'/Content/Images/tor.jpg',CAST('2009-01-08 00:00:00.000' as datetime),null,1,0),
('Эванс','Крис','Кристофер',5,' Бостон, Массачусетс, США','80296578245','80296578245','80296578245',2,'/Content/Images/cap.jpg',CAST('2008-01-08 00:00:00.000' as datetime),null,1,1),
